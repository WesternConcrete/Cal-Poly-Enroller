...
export const schema: Schema = {
  user: {
    createdCourseIds: { type: 'task', cardinality: MANY, reciprocal: 'creatorId' },
    assignedCourseIds: { type: 'task', cardinality: MANY, reciprocal: 'assigneeId' },
    commentIds: { type: 'comment', cardinality: MANY, reciprocal: 'creatorId' },
  },
  task: {
    creatorId: { type: 'user', cardinality: ONE, reciprocal: 'createdCourseIds' },
    assigneeId: { type: 'user', cardinality: ONE, reciprocal: 'assignedCourseIds' },
...
export const {
  ...
  actionTypes,
  reducer,
} = makeNormalizedSlice<FlowchartData>(schema, (actionType: string) => `project/${actionType}`);
